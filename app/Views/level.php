<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-2"><span>Level Table</h4>
        <div class="card">
            <div class="card-header">
                <a href="<?= base_url('/ConUser/t_level')?>">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?= base_url('/ConUser/e_level/'.$data->id_level)?>">
                                    ...
                                    <a href="#"
                                        onclick="openDeleteModal('<?= base_url('/ConUser/delete_level/'.$data->id_level)?>')">
