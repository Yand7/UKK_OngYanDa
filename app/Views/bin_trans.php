<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-2"><span>Daftar Transaksi Bin</h4>
        <div class="card">
                ...
                <table class="table table-striped" id="table2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $data->delete_date1?></td>
                                <td>


                                    <a href="#"
                                        onclick="openRestoreModal('<?= base_url('/ConTrans/restore_trans/'.$data->id_ntr)?>')">
                                    ...
                                    <a href="#"
                                        onclick="openDeleteModal('<?= base_url('/ConTrans/delete_trans/'.$data->id_ntr)?>')">
